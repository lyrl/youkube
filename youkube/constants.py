...
VIDEO_STATUS_DOWNLOAD_FAIL = 2  # 下载失败
VIDEO_STATUS_DOWNLOADED = 3  # 下载完成
VIDEO_STATUS_UPLOADING = 4  # 上传中
VIDEO_STATUS_UPLOADING_FAIL = 5  # 上传失败
VIDEO_STATUS_UPLOADED = 6  # 上传成功



YOUTUBE_USER_BASE_URL = "https://www.youtube.com/user/%s/videos"
YOUTUBE_CHANNEL_BASE_URL = "https://www.youtube.com/channel/%s/videos"
